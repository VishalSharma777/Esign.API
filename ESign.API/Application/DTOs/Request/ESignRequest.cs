...
public class ESignRequest
{
	...
	[DefaultValue("C000012744000bb9112")]
	public string? ReferenceId { get; set; }


	[JsonProperty("reference_doc_id")]
	[DefaultValue("C000012744000bb98a")]
...
public class SignerRequest
{
	...
	[DefaultValue("C000012744_000bb98")]
...
{
	[JsonProperty("x1")][DefaultValue(20)] public int X1 { get; set; }   // Left edge
	[JsonProperty("y1")][DefaultValue(20)] public int Y1 { get; set; }   // Top edge
	[JsonProperty("x2")][DefaultValue(120)] public int X2 { get; set; }   // Right edge
	[JsonProperty("y2")][DefaultValue(60)] public int Y2 { get; set; }   // Bottom edge
}